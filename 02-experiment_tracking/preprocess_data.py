...
def run_data_prep(raw_data_path: str, dest_path: str, dataset: str = "green"):
    ...
    dv = DictVectorizer()
    # with open("/workspaces/MLOps/02-experiment_tracking/processed_yellow_trip_data/dv.pkl", "rb") as f_in:
...
if __name__ == '__main__':
    #run_data_prep(raw_data_path="yellow_trip_data", dest_path="output")
    run_data_prep()